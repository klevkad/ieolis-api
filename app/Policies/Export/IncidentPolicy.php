...
class IncidentPolicy
{
    ...
    {
        return $user->hasPermissionTo('incidentindex');
    }
    ...
    {
        return $user->hasPermissionTo('incidentshow');
    }
    ...
    {
        return $user->hasPermissionTo('incidentcreate');
    }
    ...
    {
        return $user->hasPermissionTo('incidentupdate');
    }
    ...
    {
        return $user->hasPermissionTo('incidentdelete');
    }
